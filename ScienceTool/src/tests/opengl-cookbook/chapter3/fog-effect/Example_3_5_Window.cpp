...
core::Example_3_5_Window::Example_3_5_Window(const int w, const int h, const char* l) : Window(w, h, l),
...
{
	std::cout << "Example_3_5_Window Constructor " << std::endl;

}

core::Example_3_5_Window::~Example_3_5_Window()
{
	delete m_Program;
	delete m_VBA;
	delete m_VBO;
...
void core::Example_3_5_Window::Init()
{
	std::cout << "Example_3_5_Window Init" << std::endl;
	...
	m_Program = new Program("res/shaders/opengl-cookbook/chapter3/ex_5/FogEffect.shader");
	...
	m_Program->SetUniform3f("Light.intensity", glm::vec3(0.0f, 0.0f, 0.4f));

	m_Program->SetUniform1f("Fog.maxDist", 10);
	m_Program->SetUniform1f("Fog.minDist", 0.5f);
	m_Program->SetUniform3f("Fog.color", glm::vec3(0.5f, 0.5f, 0.5f));
...
void core::Example_3_5_Window::Loop(float dt)
{
	time += dt;
	...
	{
		m_Program->SetUniformMat4f("u_Model", glm::mat4(glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 0.0f, i))));
...
void core::Example_3_5_Window::OnKeyAction(int key, int scancode, int action, int mods)
{
...
void core::Example_3_5_Window::OnMouseMoveAction(double xpos, double ypos)
{
}

void core::Example_3_5_Window::OnMouseButtonAction(int button, int action, int mods)
{
}

void core::Example_3_5_Window::OnScrollAction(double xoffset, double yoffset)
{
}
