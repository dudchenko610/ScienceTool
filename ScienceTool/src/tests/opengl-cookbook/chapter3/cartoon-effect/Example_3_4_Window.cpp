...
core::Example_3_4_Window::Example_3_4_Window(const int w, const int h, const char* l) : Window(w, h, l),
...
{
	std::cout << "Example_3_4_Window Constructor " << std::endl;

}

core::Example_3_4_Window::~Example_3_4_Window()
{
	delete m_Program;
	delete m_VBA;
	delete m_VBO;
...
void core::Example_3_4_Window::Init()
{
	std::cout << "Example_3_4_Window Init" << std::endl;
	...
	m_Program = new Program("res/shaders/opengl-cookbook/chapter3/ex_4/CartoonEffect.shader");
	...
	m_Program->SetUniform3f("Light.intensity", glm::vec3(0.0f, 0.0f, 1.0f));
...
void core::Example_3_4_Window::Loop(float dt)
{
	time += dt;
...
void core::Example_3_4_Window::OnKeyAction(int key, int scancode, int action, int mods)
{
...
void core::Example_3_4_Window::OnMouseMoveAction(double xpos, double ypos)
{
}

void core::Example_3_4_Window::OnMouseButtonAction(int button, int action, int mods)
{
}

void core::Example_3_4_Window::OnScrollAction(double xoffset, double yoffset)
{
}
