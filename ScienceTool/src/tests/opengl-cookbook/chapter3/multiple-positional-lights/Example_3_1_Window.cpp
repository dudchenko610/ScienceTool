...
core::Example_3_1_Window::Example_3_1_Window(const int w, const int h, const char* l) : Window(w, h, l),
...
{
	std::cout << "Example_3_1_Window Constructor " << std::endl;

}

core::Example_3_1_Window::~Example_3_1_Window()
{
	delete m_Program;
	delete m_VBA;
	delete m_VBO;
...
void core::Example_3_1_Window::Init()
{
	std::cout << "Example_3_1_Window Init" << std::endl;
	...
	m_Program = new Program("res/shaders/opengl-cookbook/chapter3/ex_1/MultiplePositionalLights.shader");
//m_Program = new Program("res/shaders/opengl-cookbook/chapter3/ex_1/DirectionalLight.shader");
...
void core::Example_3_1_Window::Loop(float dt)
{
	time += dt;
...
void core::Example_3_1_Window::OnKeyAction(int key, int scancode, int action, int mods)
{
...
void core::Example_3_1_Window::OnMouseMoveAction(double xpos, double ypos)
{
}

void core::Example_3_1_Window::OnMouseButtonAction(int button, int action, int mods)
{
}

void core::Example_3_1_Window::OnScrollAction(double xoffset, double yoffset)
{
}
