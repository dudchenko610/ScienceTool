...
core::Example_7_2_Window::Example_7_2_Window(const int w, const int h) : Window(w, h, "Example_7_2_Window"),
...
{
	std::cout << "Example_7_2_Window Constructor " << std::endl;

}

core::Example_7_2_Window::~Example_7_2_Window()
{
	delete m_Program;
...
void core::Example_7_2_Window::Init()
{
	std::cout << "Example_7_2_Window Init" << std::endl;
	using namespace opengl;

	m_Grid = new Grid(true, false, false);

	//m_Program = new Program("res/shaders/opengl-cookbook/chapter2/ex_2/Flat_Shading.shader");
	m_Program = new Program("res/shaders/opengl-cookbook/chapter7/ex_2", "ShadowMaps_VS.glsl", "ShadowMaps_FS.glsl");
...
void core::Example_7_2_Window::SetupFBOWithDepthBufferOnly()
{
...
void core::Example_7_2_Window::Loop(float dt)
{
	time += dt;
...
void core::Example_7_2_Window::OnKeyAction(int key, int scancode, int action, int mods)
{
...
void core::Example_7_2_Window::OnMouseMoveAction(double xpos, double ypos)
{
}

void core::Example_7_2_Window::OnMouseButtonAction(int button, int action, int mods)
{
}

void core::Example_7_2_Window::OnScrollAction(double xoffset, double yoffset)
{
}
