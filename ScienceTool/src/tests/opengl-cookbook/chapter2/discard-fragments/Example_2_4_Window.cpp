...
core::Example_2_4_Window::Example_2_4_Window(const int w, const int h, const char* l) : Window(w, h, l),
...
core::Example_2_4_Window::~Example_2_4_Window()
{
	delete m_Program;
	delete m_VBA;
	delete m_VBO;
...
void core::Example_2_4_Window::Init()
{
	...
	parser::Vertices* verts = parser::obj::ObjParser::Parse_P_N_T("res/obj/torus_uv.objj");
	...
	m_Program = new Program("res/shaders/opengl-cookbook/chapter2/ex_4/DiscardFragment.shader");
...
void core::Example_2_4_Window::Loop(float dt)
{
	time += dt;
...
void core::Example_2_4_Window::OnKeyAction(int key, int scancode, int action, int mods)
{
...
void core::Example_2_4_Window::OnMouseMoveAction(double xpos, double ypos)
{
}

void core::Example_2_4_Window::OnMouseButtonAction(int button, int action, int mods)
{
}

void core::Example_2_4_Window::OnScrollAction(double xoffset, double yoffset)
{
}
